...
export interface Concept {
    ...
    id?: id;
    meta?: Meta;
    /** Object with following structure: key: concept code, value: amount of hops from current concept to ancestor */
    ancestors?: any;
    code: string;
    definition?: string;
    deprecated?: boolean;
...
export interface Role {
    ...
    description?: string;
    /** You may list resources for which you can later give access for user with current role using AccessPolicy resource */
    links?: RoleLinks;
    /** Role name is a string that defines role. To assign same role to multiple users create multiple Role resources with same "name" */
    name: string;
    /** Reference to User resource for which the role will be aplied */
    user: InternalReference<User>;
}
...
export interface TokenIntrospector {
    ...
    identity_provider?: InternalReference<IdentityProvider>;
